...
/**
 * Resolve a conditional value. Returns an internal missing sentinel when the condition is falsy.
 */
...
/**
 * Resolve a value that should only be included when non-null.
 */
...
/**
 * Resolve a conditional object merge payload.
 */
...
/**
 * Recursively remove internal conditional missing sentinels from a payload.
 */
